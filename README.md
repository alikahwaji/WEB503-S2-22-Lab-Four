...
## :page_facing_up: Lab Four Tasks

:arrow_right: `Use the code in the HTML file to create an HTML DOM Node Tree.`

:arrow_right: `Use the journal.MD to explain the structure of the DOM node tree.` 

:arrow_right: `Explain each level element attribute and text if they exist.`

:arrow_right: `List the approaches or methods to select any element in the HTML DOM Node Tree.`

:arrow_right: `You must provide your answer in journal Markedown file`
